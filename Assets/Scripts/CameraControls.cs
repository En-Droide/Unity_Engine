...
public class CameraControls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float resultingRotateSpeed = rotateSpeed * Time.deltaTime;
        float resultingTranslateSpeed = translateSpeed * Time.deltaTime;
        ...
        transform.Rotate(rotateAxis * resultingRotateSpeed);
        ...
        transform.Translate(translateAxis * resultingTranslateSpeed);
